...
def _status(cell: str) -> str:
    if not cell:
        return "no"
    # Support both correct UTF-8 glyphs and common variants that may appear in docs.
...
def _load_clause_meta() -> Dict[str, Dict[str, object]]:
    if not DOCS_DIR.exists():
        return {}
    path = _resolve_doc("1.Claúsulas.md", "1.Clausulas.md", "1.ClaÃºsulas.md", "1.ClaÃƒÂºsulas.md")
