...
export { applySpatialSubstitution, attackingBasketForTeam, controlBallByPlayer, createInitialSpatialState, defendingBasketForTeam, isSpatialStateInsideCourt } from './SpatialState'
...
export type { BallSpatialState, SpatialPlayerState, SpatialState } from './SpatialState'
