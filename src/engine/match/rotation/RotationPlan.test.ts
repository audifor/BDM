...
function sessionAt(clockSecondsRemaining: number, squads: MatchSquads): MatchSession {
  const profile = (playerId: typeof starters[number]) => ({ playerId, primaryPosition: 'PG' as const, offense: { usage: 50, rimAttack: 50, shooting: 50, creation: 50, ballSecurity: 50 } })
