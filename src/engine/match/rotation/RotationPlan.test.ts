...
function sessionAt(clockSecondsRemaining: number, squads: MatchSquads): MatchSession {
  return { state: { gameId: 'game' as MatchSession['state']['gameId'], homeTeamId: TEAM_ID, awayTeamId: OPPONENT_ID, initialLineups: { home: starters, away: squads.away }, activeLineups: { home: starters, away: squads.away }, squads, fatigueByPlayerId: Object.fromEntries([...squads.home, ...squads.away].map((id) => [id, 0])), homeStrength: { teamId: TEAM_ID, value: 50 }, awayStrength: { teamId: OPPONENT_ID, value: 50 }, openingTeamId: TEAM_ID, period: 1, clockSecondsRemaining, homeScore: 42, awayScore: 40, attackingTeamId: TEAM_ID, nextSequence: 1, events: [], isComplete: false }, random: {} as MatchSession['random'], actorRandom: {} as MatchSession['actorRandom'] }
}
