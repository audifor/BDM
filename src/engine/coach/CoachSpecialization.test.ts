...
function preparedWorld(points:number, attribute:number) {
  ...
  const world=createGameWorld({currentDate:source.currentDate,currentSeasonId:source.currentSeasonId,userCoachId:coachId,countries:Object.values(source.countries),coaches:Object.values(source.coaches),players:Object.values(source.players),teams:Object.values(source.teams),staffPeople:Object.values(source.staffPeopleById),teamStaffAssignments:Object.values(source.teamStaffAssignmentsById),competitions:Object.values(source.competitions),seasons:Object.values(source.seasons),games:Object.values(source.games),coachProfessionalProfilesByCoachId:{...source.coachProfessionalProfilesByCoachId,[coachId]:{attributes}},coachRpgProfilesByCoachId:{...source.coachRpgProfilesByCoachId,[coachId]:{...source.coachRpgProfilesByCoachId[coachId]!,development:{globalProgress:0,developmentPoints:points}}}})
