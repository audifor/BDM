import { calculateBootstrapAbilityProxy, type LegacyPlayerRatings, type PlayerPotential, type PlayerRatings } from '@/domain/player'
import { hashStringToSeed, SeededRandomSource } from '@/engine/random'

export function generatePlayerPotential(playerId: string, ratings: PlayerRatings | LegacyPlayerRatings, age: number): PlayerPotential {
