...
function buildBundle(): WorldDbCompetitionBundleV1 {
  return {
    ...
    structurePositions: [
      { competitionStructurePositionId: 'position:sf:1', competitionStructureNodeId: 'node:sf', positionType: 'BRACKET_SLOT', positionOrder: 1, label: 'SF slot 1' },
      { competitionStructurePositionId: 'position:sf:2', competitionStructureNodeId: 'node:sf', positionType: 'BRACKET_SLOT', positionOrder: 2, label: 'SF slot 2' },
    ],
    structureEdges: [],
    structureEntryAssignments: [],
    fixtures: [{ competitionFixtureId: 'fixture:sf', structureNodeId: 'node:sf', matchdayId: null, fixtureOrder: 1 }],
    fixtureSides: [
      { competitionFixtureSideId: 'side:home', competitionFixtureId: 'fixture:sf', sideRole: 'HOME', competitionSeasonEntryId: null, competitionSeasonSlotId: null, sourceStructurePositionId: 'position:sf:1' },
      { competitionFixtureSideId: 'side:away', competitionFixtureId: 'fixture:sf', sideRole: 'AWAY', competitionSeasonEntryId: null, competitionSeasonSlotId: null, sourceStructurePositionId: 'position:sf:2' },
    ],
    rulePayloads: {},
  }
}
