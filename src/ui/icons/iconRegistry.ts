...
export const BDM_APP_ICON_BY_ID = { bdm: 'home', squad: 'roster', analysis: 'tactics', 'locker-room': 'team', mentoring: 'staff', tactics: 'tactics', training: 'training', staff: 'staff', medical: 'medical', schedule: 'schedule', match: 'match', competition: 'competition', market: 'market', club: 'club', board: 'board', finances: 'finances', enforcement: 'compliance', coach: 'profile', 'coach-finances': 'patrimony', media: 'media', narratives: 'histories', memories: 'memories', recruiting: 'recruiting', nil: 'nil', boosters: 'boosters', settings: 'settings' } as const satisfies Record<string, BdmIconName>
