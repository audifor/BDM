...
import { BarChart3, TrendingUp, Shield, Crown } from "../../ClubIcons";
  ...
  return (
    <section className="bento club-analytics">
      <div className="card hero modal-glass-tactical">
        ...
        <div className="desc">
          {teamName || "Equipo"} Â· {analytics?.league_name || analytics?.league_id || "--"} Â·{" "}
            ...
            return (
              <div key={metric.key} className="analytics-metric">
                ...
                <div className="metric-sub">
                  Liga {formatValue(leagueValue, metric.kind)} Â· Rank {rank || "--"}
                </div>
              </div>
            );
          })}
