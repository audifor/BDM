...
import { DollarSign, TrendingUp, TrendingDown, AlertCircle, Calendar } from "../../ClubIcons";
...
export default function ClubFinances({
    ...
    return (
      <div className="finances-overview">
        ...
        <div className="card modal-glass-tactical projected-card">
          <div className="card-header">
            <h3>ProyecciÃ³n de Temporada</h3>
            <Calendar size={20} />
          </div>
          <div className="balance-breakdown">
            <div className="breakdown-item income">
          ...
          {projected.balance < 0 && (
            <div className="projection-warning">
              <AlertCircle size={16} />
              <span>Â¡Advertencia! Se proyecta dÃ©ficit. Reduce gastos o aumenta ingresos.</span>
            </div>
          )}
        </div>
  ...
  const ProjectionsPanel = () => {
    // Generar datos mensuales simulados para el grÃ¡fico
    const months = [
      "Ene",
      "Feb",
      "Mar",
    ...
    // Balance mensual proyectado (distribuciÃ³n uniforme simplificada)
    ...
    return (
      <div className="finances-projections">
        <div className="card modal-glass-tactical projections-chart">
          <div className="card-header">
            <h3>ProyecciÃ³n Mensual de Balance</h3>
          </div>
        ...
        <div className="card modal-glass-tactical projections-summary">
          ...
          <div className="summary-items">
            ...
            <div className="summary-item">
              <div className="summary-label">Mes CrÃ­tico:</div>
              <div className="summary-value">
    ...
    <section className="bento club-finances">
      <div className="card hero modal-glass-tactical">
        <div className="card-header">
          ...
          <span className="pill">AÃ±o Fiscal {fiscalYear}</span>
        </div>
        <div className="desc">
          Gestiona el presupuesto del club con proyecciones de ingresos y gastos. MantÃ©n un
