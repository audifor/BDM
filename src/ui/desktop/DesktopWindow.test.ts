...
describe('DesktopWindow', () => {
  it('renders titlebar, accessible controls and resize handles', () => {
    const markup = renderToStaticMarkup(createElement(DesktopWindow, { focused: true, window: windowState, onClose: () => undefined, onFocus: () => undefined, onMaximize: () => undefined, onMinimize: () => undefined, onMove: () => undefined, onResize: () => undefined, onRestoreMaximized: () => undefined, children: 'Home content' }))
