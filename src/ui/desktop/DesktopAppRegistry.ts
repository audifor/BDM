...
export const DESKTOP_APPS: readonly DesktopAppDefinition[] = [
  ...
  app({ id: 'coach', label: 'Perfil', icon: 'team', section: 'coach', defaultPinned: false, availability: 'available', launcherOrder: 60, singleton: true, window: { width: 920, height: 700, minWidth: 600, minHeight: 460 }, renderKey: 'coach' }),
