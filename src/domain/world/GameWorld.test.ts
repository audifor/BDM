...
describe('GameWorld', () => {
  ...
  it('stores Political Cases and validates their team and optional subject Staff references', () => {
    ...
    expect(() => createGameWorld({ ...input, staffPoliticalCases: [politicalCase, politicalCase] })).toThrow(GameWorldValidationError)
    expect(() => createGameWorld({ ...input, staffPoliticalCases: [politicalCase, { ...politicalCase, id: 'alternate-source-id' }] })).toThrow(RangeError)
  })
