export const PERSONALITY_DIMENSIONS = ['ambition', 'professionalism', 'loyalty', 'resilience', 'temperament', 'teamOrientation'] as const
...
export function generatePersonality(personId: string): Personality {
  ...
  return createPersonality({ values: { ambition: value(), professionalism: value(), loyalty: value(), resilience: value(), temperament: value(), teamOrientation: value() } })
}
