...
export interface EligibilityRestriction { readonly id: string; readonly playerId: PlayerId; readonly ecosystemId: EcosystemId; readonly reasonCode: string; readonly startsAt: GameDate; readonly endsAt?: GameDate }
