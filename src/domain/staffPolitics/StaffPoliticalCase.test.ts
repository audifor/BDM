...
const open = { id: 'staff-political-case:team:CAREER_REQUEST:request', scopeKey: 'team', teamId: 'team' as never, sourceKind: 'CAREER_REQUEST' as const, sourceId: 'request', agenda: 'CAREER' as const, subjectStaffId: 'staff' as never, openedOn: '2032-01-01' as never, lastEvaluatedOn: '2032-01-01' as never, status: 'OPEN' as const }
