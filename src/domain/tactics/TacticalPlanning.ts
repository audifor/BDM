...
export interface TeamRotationIntent { readonly teamId:TeamId; readonly instructions:readonly {readonly period:number;readonly clockThresholdSeconds:number;readonly playerOutId:PlayerId;readonly playerInId:PlayerId}[] }
