...
export type PickAndRollCoverage='switch'|'drop'|'hedge'|'blitz'
export const PICK_AND_ROLL_COVERAGE_OPTIONS:readonly {readonly value:PickAndRollCoverage;readonly label:string}[]=[{value:'switch',label:'Switch'},{value:'drop',label:'Drop'},{value:'hedge',label:'Hedge'},{value:'blitz',label:'Blitz'}]
/** Persisted counterpart of the engine's executable tactic: domain stays engine-free. */
export interface TeamTacticalInstructions { readonly pace:TacticalLevel; readonly shotProfile:{readonly rim:TacticalLevel;readonly midRange:TacticalLevel;readonly threePoint:TacticalLevel};readonly defense:{readonly interior:TacticalLevel;readonly perimeter:TacticalLevel;readonly pickAndRollCoverage?:PickAndRollCoverage};readonly featuredPlayerId?:PlayerId }
/**
...
export function createDefaultTeamTacticalPlan(teamId:TeamId):TeamTacticalPlan{return{teamId,instructions:{pace:0,shotProfile:{rim:0,midRange:0,threePoint:0},defense:{interior:0,perimeter:0,pickAndRollCoverage:'switch'}}}}
