  ...
  return (
    <div className="po-role">
      <div className="po-role__primary">
        ...
        <strong className="po-role__value">
          <PlayPositionMark position={roleProfile.primaryPosition} />
          {roleProfile.secondaryPositions.map((position) => (
            <PlayPositionMark key={position} position={position} />
          ))}
        </strong>
      </div>
