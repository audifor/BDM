...
import { createCollectiveInstitutionAffiliation, createCollectiveParticipantAffiliation, createSupporterRelationship, COLLECTIVE_AFFILIATION_KINDS, COLLECTIVE_PARTICIPANT_KINDS, DONOR_PATTERNS, INSTITUTIONAL_SUPPORT_SCOPES, SUPPORTER_RELATIONSHIP_KINDS, type CollectiveInstitutionAffiliation, type CollectiveParticipantAffiliation, type SupporterRelationship } from '@/domain/supporters'
...
function parseStaffCareerRuntimeV3(value: unknown): {
  ...
  readonly supporterRelationships: readonly SupporterRelationship[]; readonly collectiveInstitutionAffiliations: readonly CollectiveInstitutionAffiliation[]; readonly collectiveParticipantAffiliations: readonly CollectiveParticipantAffiliation[]
} {
