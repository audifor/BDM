...
export function deserializeGameWorldV3(value: unknown): GameWorld {
  ...
  const withStaffCareer = updateGameWorld(world, {
    ...
    governanceMeetings: runtime.governanceMeetings, governanceMeetingParticipants: runtime.governanceMeetingParticipants, governanceMeetingAgendaItems: runtime.governanceMeetingAgendaItems, governanceMeetingEvents: runtime.governanceMeetingEvents,
  })
...
function v3Payload(payload: GameWorldSaveV2, world: GameWorld): GameWorldSaveV3 {
  return {
    ...
    staffCareerRuntime: {
      ...
      governanceMeetings: values(world.governanceMeetingsById), governanceMeetingParticipants: values(world.governanceMeetingParticipantsById), governanceMeetingAgendaItems: values(world.governanceMeetingAgendaItemsById), governanceMeetingEvents: values(world.governanceMeetingEventsById),
    },
  }
}
...
function parseStaffCareerRuntimeV3(value: unknown): {
  ...
  readonly governanceMeetings: readonly GovernanceMeeting[]; readonly governanceMeetingParticipants: readonly GovernanceMeetingParticipant[]; readonly governanceMeetingAgendaItems: readonly GovernanceMeetingAgendaItem[]; readonly governanceMeetingEvents: readonly GovernanceMeetingEvent[]
} {
