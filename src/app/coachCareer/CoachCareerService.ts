...
export function createCoachJobOffer(world: GameWorld, input: { readonly candidacyId: string; readonly id?: string }): { readonly world: GameWorld; readonly offerId: string } {
  ...
  return { world: rebuild(world, { candidacies: { ...world.coachJobCandidaciesById, [candidacy.id]: transitioned.candidacy }, offers: { ...world.coachJobOffersById, [id]: { id, jobOpeningId: opening.id, coachId: candidacy.coachId, teamId: opening.teamId, createdOn: world.currentDate, status: 'pending' } } }), offerId: id }
}
...
export function acceptCoachJobOffer(world: GameWorld, offerId: string): GameWorld {
  ...
  return rebuild(world, { teams, openings, candidacies, offers, employment: { ...world.coachEmploymentByCoachId, [offer.coachId]: appointed.employment }, history: { ...world.coachCareerHistoryByCoachId, [offer.coachId]: appointed.history } })
}
