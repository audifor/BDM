...
function slice(): WorldDbGameBootstrapSliceV1 {
  ...
  const organizations = [...new Map(teams.map((team) => [team.organizationId, { organizationId: team.organizationId, entityId: `entity:${team.organizationId}`, legalName: `Legal ${team.organizationId}`, foundedYear: 1900, dissolvedYear: null, primaryPlaceId: 'place:country:ESP', website: null }])).values()]
