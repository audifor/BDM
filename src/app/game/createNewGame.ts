...
export function createNewGame(options: { readonly coachRpgPreset?: CoachRpgPreset } = {}): GameWorld {
  const generatedWorld = generateWorld({ ...PROTOTYPE_GAME_CONFIGURATION, userCoachRpgPreset: options.coachRpgPreset, includeNbaLike: true })
  ...
  return ensurePlayerKnowledge(createGameWorld({
    ...
    competitions, ecosystems: Object.values(generatedWorld.ecosystems),
    seasons,
    games,
