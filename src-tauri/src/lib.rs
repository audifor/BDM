...
#[tauri::command]
fn load_world_db_selection_catalog_v1(
    database_path: String,
) -> Result<world_db_selection::WorldDbSelectionCatalogV1, String> {
    world_db_selection::load_selection_catalog_v1(&database_path)
}
