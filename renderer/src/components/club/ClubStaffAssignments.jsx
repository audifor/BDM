...
import { Users, TrendingUp, Award, AlertCircle, Plus } from "lucide-react";
...
export default function ClubStaffAssignments({
  ...
  const ROLES = {
    head_coach: {
      ...
      effects: "Afecta táctica general, rotaciones y moral del equipo",
      limit: 1,
    },
    assistant_off: {
      ...
      effects: "+% desarrollo atributos ofensivos (tiro, manejo, visión)",
      limit: 1,
    },
    assistant_def: {
    ...
    physio: {
      ...
      effects: "+% recuperación de lesiones y fatiga",
      limit: 2,
    },
    dev_coach: {
      ...
      effects: "+% desarrollo para jugadores jóvenes (<23 años)",
      limit: 2,
    },
    strength: {
      ...
      effects: "+% desarrollo físico (fuerza, velocidad, resistencia)",
      limit: 1,
    },
    scout: {
      label: "Ojeador",
      ...
      effects: "Más atributos revelados, mejor evaluación de mercado",
      limit: 3,
    },
  };
  ...
  // Calcular bonus total del staff en un área
  const calculateBonus = (area) => {
    ...
    Object.values(assignments).forEach((assignment) => {
      ...
      if (role.skills.includes(area)) {
        ...
        total += (skillValue - 500) / 5000; // +10% máx por staff top
      }
    });
    return total;
  };
                ...
                available.map((staff) => (
                  ...
                  >
                    ...
                    <div className="staff-wage">
                      {staff.wage ? `$${(staff.wage / 1000).toFixed(0)}K/año` : ""}
                    </div>
                  </div>
                ))
              )}
    ...
    return (
      <div className="card modal-glass-tactical team-bonuses">
        ...
        <div className="bonus-grid">
          ...
          <div className="bonus-item">
            <div className="bonus-label">Recuperación</div>
            <div className="bonus-value">
              {recoveryBonus > 0 ? "+" : ""}
  ...
  return (
    <section className="bento club-staff-assignments">
      <div className="card hero modal-glass-tactical">
        ...
        <div className="desc">
          Asigna a tu staff a roles específicos para maximizar las
          bonificaciones de desarrollo, táctica y recuperación.
        </div>
      </div>
